...
cast.save()
cast_name=Cast_name(cast_name_id=1,cast_name="Dwayne Johnson",image_id=1)
cast_name.save()
cast_name=Cast_name(cast_name_id=2,cast_name="Idris Elba",image_id=2)
cast_name.save()
cast_name=Cast_name(cast_name_id=3,cast_name="Vanessa",image_id=3)
cast_name.save()
cast_name=Cast_name(cast_name_id=4,cast_name="Jason Stathan",image_id=4)
cast_name.save()
...
season.save()
episode=Episode(episode_id=2,episode_no=1,episode_name="EP 1",link_list_id=2,episode_duration=36000,desc="this is episode description")
episode.save()
...
subtitle_list.save()
-- subtitle_name=Subtitle_name(subtitle_name_id=2,subtitle_name="English",subtitle_short_code="EN")
-- subtitle_name.save()
...
movies=Movies_list(id=5,name="Game of Thrones",genres_list_id=5,cast_id=5,director_id=5,writer_id=5,country_id=1,story_line="Tn the mythical continent of west error several powerful familier for control of the seven Kingdom",season_id=5,cost=40000,Award_id=5,release='2019-04-14',IMDB_ratting=9.1,trailer_link="https://youtube.com/",ratting=8.1,imdb_link="https://imdb.com.movies/12421",tags="games,of,Thrones,season-1,2,3,4,5,6")
movies.save()
...
cast.save()
cast_name=Cast_name(cast_name_id=5,cast_name="Lena Headey")
cast_name.save()
cast_name=Cast_name(cast_name_id=6,cast_name="Peter Dinklag ")
cast_name.save()
...
season.save()
episode=Episode(episode_id=15,episode_no=1,episode_name="Episode 1",link_list_id=15,episode_duration=42000,desc="this is episode 1 description")
episode.save()
episode=Episode(episode_id=15,episode_no=2,episode_name="Episode 2",link_list_id=16,episode_duration=48000,desc="this is episode 2 description")
episode.save()
episode=Episode(episode_id=15,episode_no=3,episode_name="Episode 3",link_list_id=17,episode_duration=35000,desc="this is episode 3 description")
episode.save()
episode=Episode(episode_id=15,episode_no=4,episode_name="Episode 4",link_list_id=18,episode_duration=13000,desc="this is episode 4 description")
episode.save()
episode=Episode(episode_id=15,episode_no=5,episode_name="Episode 5",link_list_id=19,episode_duration=15000,desc="this is episode 5 description")
episode.save()
...
season.save()
episode=Episode(episode_id=16,episode_no=1,episode_name="Episode 2.1",link_list_id=20,episode_duration=52000,desc="this is episode 2.1 description")
episode.save()
episode=Episode(episode_id=16,episode_no=2,episode_name="Episode 2.2",link_list_id=21,episode_duration=58000,desc="this is episode 2.2 description")
episode.save()
episode=Episode(episode_id=16,episode_no=3,episode_name="Episode 2.3",link_list_id=22,episode_duration=45000,desc="this is episode 2.3 description")
episode.save()
episode=Episode(episode_id=16,episode_no=4,episode_name="Episode 2.4",link_list_id=23,episode_duration=23000,desc="this is episode 2.4 description")
episode.save()
episode=Episode(episode_id=16,episode_no=5,episode_name="Episode 2.5",link_list_id=24,episode_duration=25000,desc="this is episode 2.5 description")
episode.save()
...
season.save()
episode=Episode(episode_id=17,episode_no=1,episode_name="Episode 3.1",link_list_id=25,episode_duration=53000,desc="this is episode 3.1 description")
episode.save()
episode=Episode(episode_id=17,episode_no=2,episode_name="Episode 3.2",link_list_id=26,episode_duration=54000,desc="this is episode 3.2 description")
episode.save()
episode=Episode(episode_id=17,episode_no=3,episode_name="Episode 3.3",link_list_id=27,episode_duration=42000,desc="this is episode 3.3 description")
episode.save()
episode=Episode(episode_id=17,episode_no=4,episode_name="Episode 3.4",link_list_id=28,episode_duration=21000,desc="this is episode 3.4 description")
episode.save()
episode=Episode(episode_id=17,episode_no=5,episode_name="Episode 3.5",link_list_id=29,episode_duration=2000,desc="this is episode 3.5 description")
episode.save()
